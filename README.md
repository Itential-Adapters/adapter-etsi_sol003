...
| concurrent\_max | Defines the number of requests the adapter can send to Etsi_sol003 at one time (minimum = 1, maximum = 1000). The default is 1 meaning each request must be sent to Etsi_sol003 in a serial manner. |
...
| Property | Description |
| ------- | ------- |
| enabled | Required. Default is false. If Etsi_sol003 is behind a proxy server, set enabled flag to true. |
